...
x=Conv2D(64,kernel_size=(3,3),strides=(1,1))(input_tensor)
...
x=Conv2D(512,kernel_size=(3,3),strides=(1,1))(x)
x=BatchNormalization()(x)
x=Activation('relu')(x)
x=MaxPooling2D(pool_size=(2,2))(x)
x = block(512,upscale=False)(x)
x=Conv2D(1024,kernel_size=(3,3),strides=(1,1))(x)
x=BatchNormalization()(x)
x=Activation('relu')(x)
x=MaxPooling2D(pool_size=(2,2))(x)
...
#print(y)
dataset,values=dt('/home/ws2/Documents/skdataset/seg1/train/',categories)
#print(dataset.shape)
#print(values.shape)
dataset1,values1=dt('/home/ws2/Documents/skdataset/seg1/valid/',categories)
...
best_weights_filepath = model_path+'best_weights4.hdf5'
