...
bone_list=[[6,4],[4,13],[13,15],[15,17]]
...
#     plt.show()                
    plt.savefig('/home/ws2/Documents/msr_leftleg/'+title+'.png',dpi=100)
    croppingimage('/home/ws2/Documents/msr_leftleg/'+title+'.png')                    
    
    
    
for file in os.listdir('/home/ws2/Downloads/MSRAction3DSkeletonReal3D'):
    title=file[:-4]
    if(os.path.exists(os.path.join('/home/ws2/Documents/msr_leftleg',title+'.png'))):
        print('continue')
        continue
    func(file)
    print(file)
