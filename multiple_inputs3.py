...
from keras.layers import Input, Conv2D, Activation, BatchNormalization, GlobalAveragePooling2D
...
base_model1 = ResNet50(input_shape = IMAGE_SIZE + [3],include_top=False )
base_model2 = ResNet50(input_shape = IMAGE_SIZE + [3],include_top=False )
base_model3 = ResNet50(input_shape = IMAGE_SIZE + [3],include_top=False )
base_model4 = ResNet50(input_shape = IMAGE_SIZE + [3],include_top=False )
base_model5 = ResNet50(input_shape = IMAGE_SIZE + [3],include_top=False )
...
path ="/home/ws2/Documents/FINAL_DATA/seg1/"
...
x1 = Flatten()(model1.layers[-1].output)
x1 = BatchNormalization()(x1)
x1 = Dense(512, activation='relu')(x1)
x1 = BatchNormalization()(x1)
x1 = Activation('relu')(x1)
x2 = Flatten()(model2.layers[-1].output)
x2 = BatchNormalization()(x2)
x2 = Dense(512, activation='relu')(x2)
x2 = BatchNormalization()(x2)
x2 = Activation('relu')(x2)
x3 = Flatten()(model3.layers[-1].output)
x3 = BatchNormalization()(x3)
x3 = Dense(512, activation='relu')(x3)
x3 = BatchNormalization()(x3)
x3 = Activation('relu')(x3)
x4 = Flatten()(model4.layers[-1].output)
x4 = BatchNormalization()(x4)
x4 = Dense(512, activation='relu')(x4)
x4 = BatchNormalization()(x4)
x4 = Activation('relu')(x4)
x5 = Flatten()(model5.layers[-1].output)
...
model = Model(inputs=[i1,i2,i3,i4,i5],outputs=output)
...
def fit_model(model, dataset1,dataset2,dataset3,dataset4,dataset5,onehot_encoded1,validdataset1,validdataset2,validdataset3,validdataset4,validdataset5,onehot_encoded):
    hist = model.fit_generator(generator_two_img(dataset1, dataset2,dataset3,dataset4,dataset5, 
                                                 onehot_encoded1, 64),
                               steps_per_epoch=len(dataset1) // 64, 
                               epochs= 200,
                               callbacks = [],
                               ...
                               validation_steps=len(validdataset1) // 64, 
                               verbose=1)
...
fit_model(model, dataset1,dataset2,dataset3,dataset4,dataset5,onehot_encoded1,validdataset1,validdataset2,validdataset3,validdataset4,validdataset5,onehot_encoded)
