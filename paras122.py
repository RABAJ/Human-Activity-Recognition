...
bone_list=[[1,13],[13,14],[14,15],[15,16]]
...
#                     continue
    ...
    #                         print(x)
        ...
        plt.savefig('/home/ws2/Documents/nturgb_leftleg/'+title+'.png',dpi=100)
        croppingimage('/home/ws2/Documents/nturgb_leftleg/'+title+'.png')
#         plt.show()
...
for file in os.listdir('/home/ws2/Downloads/nturgb+d_skeletons'):
    if('P001' in file):
        title=file[:-9]
        if(os.path.exists(os.path.join('/home/ws2/Documents/nturgb_leftleg',title+'.png'))):
            print('continue')
            continue
        func(file)
