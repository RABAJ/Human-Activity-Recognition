...
class TestCallback(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        if(top_5_accuracy > self.xx):
            ...
            #predicted array's path
            np.save('/home/ws2/Documents/msrpredarray/pred_msr_fuskdata.npy', model1_pred)
            print(classes)
...
#traintest_dataparts  -------UTKinect dataset

#path = "/home/ws2/Documents/cropdata/"

#MSR ACTION 3D DATASTET
path ="/home/ws2/Documents/ttfidmsr_fusk/train/"
#path="/home/ws2/Documents/ttfidmsr_headspinal/train/"
#path="/home/ws2/Documents/ttfidmsr_lefthand/train/"
#path="/home/ws2/Documents/ttfidmsr_righthand/train/"
#path="/home/ws2/Documents/ttfidmsr_leftleg/train/"
#path="/home/ws2/Documents/ttfidmsr_rightleg/train/"

#UTKINECT DATASET INPUT
...
#Florence dataset input
#path="/home/ws2/Documents/ttfidflore_righthand_new/train/"
#path="/home/ws2/Documents/ttfidflore_headspinal/train/"
#path="/home/ws2/Documents/ttfidflore_lefthand_new/train/"
#path="/home/ws2/Documents/ttfidflore_leftleg/train/"
#path="/home/ws2/Documents/ttfidflore_rightleg/train/"
#path ="/home/ws2/Documents/ttfidflore_fusk/train/"
...
#h=LeakyReLU(alpha=0.1)(h)
#h = BatchNormalization()(h)
output = Dense(8, activation='softmax')(h)
...
folder = path+'valid'
#as1 msr categories
categories=['a02','a03','a05','a06','a10','a13','a18','a20']
...
dataset,values=dt('/home/ws2/Documents/ttfidmsr_fusk/train',categories)
#dataset,values=dt('/home/ws2/Documents/ttfidflore_fusk/train/',categories)

#print(dataset.shape)
#print(values.shape)
#dataset,values=dt('/home/ws2/Documents/traintest_dataparts/seg1/valid/head_spinal',categories)
dataset1,values1=dt('/home/ws2/Documents/ttfidmsr_fusk/valid',categories)
dataset1,values1=dt('/home/ws2/Documents/ttfidflore_fusk/valid/',categories)
# In[ ]:
#y_labels=onehot(y)
...
best_weights_filepath = model_path+'aril_best_weights12.hdf5'
...
aug = ImageDataGenerator(rotation_range=60, zoom_range=0.2,fill_mode='nearest',
...
def fit_model(model, dataset1,onehot_encoded1,dataset,onehot_encoded):
    history = model.fit_generator(aug.flow(dataset,onehot_encoded, batch_size=64),
                            ...
                            epochs=1000,callbacks=[saveBestModel,TestCallback((dataset1, onehot_encoded1))])
    print(history.history.keys())
    # summarize history for accuracy
    acc=(history.history['top_5_accuracy'])
    
    np.save('/home/ws2/Documents/newmodelsarray_msrfusk/acc_seg1_msrfusk.npy', acc)
    acc1=(history.history['acc'])
    np.save('/home/ws2/Documents/newmodelsarray_msrfusk/acc1_seg1_msrfusk.npy', acc1)
    acc2=(history.history['top_3_accuracy'])
    np.save('/home/ws2/Documents/newmodelsarray_msrfusk/acc2_seg1_msrfusk.npy', acc2)
    val_acc=(history.history['val_top_5_accuracy'])
    np.save('/home/ws2/Documents/newmodelsarray_msrfusk/val_acc_seg1_msrfusk.npy', val_acc)
    loss=(history.history['loss'])
    np.save('/home/ws2/Documents/newmodelsarray_msrfusk/loss_seg1_msrfusk.npy', loss)
    val_loss=(history.history['val_loss'])
    np.save('/home/ws2/Documents/newmodelsarray_msrfusk/val_loss_seg1_msrfusk.npy', val_loss)

    
opt = Adam(lr=0.001,decay=1e-6)
#model.compile(optimizer=opt, loss='categorical_crossentropy', metrics=['accuracy'])
model.compile(optimizer=opt, loss='categorical_crossentropy', metrics=['acc',top_3_accuracy,top_5_accuracy])
