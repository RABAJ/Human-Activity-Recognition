...
path1 ="/home/ws2/Documents/finaldata1/seg1/train/head_spinal/"
path2 ="/home/ws2/Documents/finaldata1/seg1/train/left_hand/"
path3 ="/home/ws2/Documents/finaldata1/seg1/train/left_leg/"
path4 ="/home/ws2/Documents/finaldata1/seg1/train/right_hand/"
path5 ="/home/ws2/Documents/finaldata1/seg1/train/right_leg/"
model_path1 = path1 + 'models/'
model_path2 = path2 + 'models/'
model_path3 = path3 + 'models/'
model_path4 = path4 + 'models/'
model_path5 = path5 + 'models/'
if not os.path.exists(model_path1): os.mkdir(model_path1)
if not os.path.exists(model_path2): os.mkdir(model_path2)
if not os.path.exists(model_path3): os.mkdir(model_path3)
if not os.path.exists(model_path4): os.mkdir(model_path4)
if not os.path.exists(model_path5): os.mkdir(model_path5)
...
#print(y)
dataset,values=dt('/home/ws2/Documents/finaldata1/seg1/train/right_leg',categories)
#print(dataset.shape)
#print(values.shape)
dataset1,values1=dt('/home/ws2/Documents/finaldata1/seg1/valid/right_leg',categories)
...
# In[ ]:/home/ws2/Documents/finaldata1/seg4/valid/right_leg

#nb_epoch=50
#p=TestCallback((dataset, onehot_encoded))
best_weights_filepath = model_path+'best_weights3_resnet.hdf5'
...
def fit_model(model, dataset1,onehot_encoded1,dataset,onehot_encoded):
    history = model.fit_generator(aug.flow(dataset1,onehot_encoded1, batch_size=64),
    ...
    np.save('/home/ws2/Documents/resnetmodelsarray/acc_seg1_right_leg.npy', acc)
    val_acc=(history.history['val_acc'])
    np.save('/home/ws2/Documents/resnetmodelsarray/val_acc_seg1_right_leg.npy', val_acc)
    loss=(history.history['loss'])
    np.save('/home/ws2/Documents/resnetmodelsarray/loss_seg1_right_leg.npy', loss)
    val_loss=(history.history['val_loss'])
    np.save('/home/ws2/Documents/resnetmodelsarray/val_loss_seg1_right_leg.npy', val_loss)
