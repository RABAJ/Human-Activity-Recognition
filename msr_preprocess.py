...
bone_list=[[19,2],[2,0],[0,7],[7,9],[9,11],[2,1],[1,8],[8,10],[10,12],[2,3],[3,6],[6,5],[5,14],[14,16],[16,18],[6,4],[4,13],[13,15],[15,17]]
...
#     plt.show()                
    plt.savefig('/home/ws2/Documents/msr_fusk/'+title+'.png',dpi=100)
    croppingimage('/home/ws2/Documents/msr_fusk/'+title+'.png')                    
    
    
    
for file in os.listdir('/home/ws2/Downloads/MSRAction3DSkeletonReal3D'):
    title=file[:-4]
    if(os.path.exists(os.path.join('/home/ws2/Documents/msr_fusk',title+'.png'))):
        print('continue')
        continue
