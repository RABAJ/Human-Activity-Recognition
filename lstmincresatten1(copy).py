...
class TestCallback(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        if(top_5_accuracy > self.xx):
            ...
            np.save('/home/ws2/Documents/predarray/pred_fuskdata1.npy', model1_pred)
            print(classes)
...
path ="/home/ws2/Documents/fuskdata1/train/"
...
#print(y)
dataset,values=dt('/home/ws2/Documents/fuskdata1/train',categories)
#print(dataset.shape)
#print(values.shape)
dataset1,values1=dt('/home/ws2/Documents/fuskdata1/valid',categories)
...
best_weights_filepath = model_path+'aril_best_weights13.hdf5'
...
def fit_model(model, dataset1,onehot_encoded1,dataset,onehot_encoded):
    history = model.fit_generator(aug.flow(dataset,onehot_encoded, batch_size=64),
                            ...
                            epochs=200,callbacks=[saveBestModel,TestCallback((dataset1, onehot_encoded1))])
    print(history.history.keys())
    # summarize history for accuracy
    acc=(history.history['top_5_accuracy'])
    
    np.save('/home/ws2/Documents/newmodelsarray/acc_seg1_fuskdata1.npy', acc)
    acc1=(history.history['acc'])
    np.save('/home/ws2/Documents/newmodelsarray/acc1_seg1_fuskdata1.npy', acc1)
    acc2=(history.history['top_3_accuracy'])
    np.save('/home/ws2/Documents/newmodelsarray/acc2_seg1_fuskdata1.npy', acc2)
    val_acc=(history.history['val_top_5_accuracy'])
    np.save('/home/ws2/Documents/newmodelsarray/val_acc_seg1_fuskdata1.npy', val_acc)
    loss=(history.history['loss'])
    np.save('/home/ws2/Documents/newmodelsarray/loss_seg1_fuskdata1.npy', loss)
    val_loss=(history.history['val_loss'])
    np.save('/home/ws2/Documents/newmodelsarray/val_loss_seg1_fuskdata1.npy', val_loss)
