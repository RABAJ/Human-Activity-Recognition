...
bone_list=[[1,17],[17,18],[18,19],[19,20]]
...
#                     continue
    ...
    #                         print(x)
        ...
        plt.savefig('/home/ws2/Documents/nturgb_rightleg/'+title+'.png',dpi=100)
        croppingimage('/home/ws2/Documents/nturgb_rightleg/'+title+'.png')
#         plt.show()
...
for file in os.listdir('/home/ws2/Downloads/nturgb+d_skeletons'):
    if('P001' in file):
        title=file[:-9]
        if(os.path.exists(os.path.join('/home/ws2/Documents/nturgb_rightleg',title+'.png'))):
            print('continue')
            continue
        func(file)
