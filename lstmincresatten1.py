...
from keras.layers import Input, Conv2D, Activation, BatchNormalization, GlobalAveragePooling2D, Dense, Dropout,Add,Multiply,LSTM,Reshape
...
x3=Conv2D(64,kernel_size=(5,5),padding='same',strides=(1,1))(x3)
x3=BatchNormalization()(x3)
...
def fit_model(model, dataset1,onehot_encoded1,dataset,onehot_encoded):
    history = model.fit_generator(aug.flow(dataset,onehot_encoded, batch_size=64),
                            ...
                            epochs=1000,callbacks=[saveBestModel,TestCallback((dataset, onehot_encoded))])
    print(history.history.keys())
    # summarize history for accuracy
    #acc=(history.history['acc'])
    #np.save('/home/ws2/Documents/newmodelsarray/acc_seg1_fuskdata1_c.npy', acc)
    #val_acc=(history.history['val_acc'])
    #np.save('/home/ws2/Documents/newmodelsarray/val_acc_seg1_fuskdata1_c.npy', val_acc)
    #loss=(history.history['loss'])
    #np.save('/home/ws2/Documents/newmodelsarray/loss_seg1_fuskdata1_c.npy', loss)
    #val_loss=(history.history['val_loss'])
    #np.save('/home/ws2/Documents/newmodelsarray/val_loss_seg1_fuskdata1_c.npy', val_loss)
