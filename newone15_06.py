...
from keras.layers import Input, Conv3D, Activation, BatchNormalization, GlobalAveragePooling3D, Dense, Dropout,MaxPooling3D
...
def block(n_output, upscale=False):
    ...
    def f(x):
        ...
        h = Conv3D(kernel_size=(3,3,3), filters=n_output, strides=(1,1,1), padding='same')(x)
        ...
        if upscale:
            # 1x1 conv2d
            f = Conv3D(kernel_size=(1,1,1), filters=n_output, strides=(1,1,1), padding='same')(x)
        else:
            # identity
            f = x
...
x=Conv3D(64,kernel_size=(3,3,3),strides=(1,1,1))(input_tensor)
x=BatchNormalization()(x)
x=Activation('relu')(x)
x=MaxPooling3D(pool_size=(2,2,2))(x)
x = block(64,upscale=False)(x)
x=Conv3D(128,kernel_size=(3,3,3),strides=(1,1,1))(x)
x=BatchNormalization()(x)
x=Activation('relu')(x)
x=MaxPooling3D(pool_size=(2,2,2))(x)
x = block(128,upscale=False)(x)
x=Conv3D(256,kernel_size=(3,3,3),strides=(1,1,1))(x)
x=BatchNormalization()(x)
x=Activation('relu')(x)
x=MaxPooling3D(pool_size=(2,2,2))(x)
x = block(256,upscale=False)(x)
x=Conv3D(512,kernel_size=(3,3,3),strides=(1,1,1))(x)
x=BatchNormalization()(x)
x=Activation('relu')(x)
x=MaxPooling3D(pool_size=(2,2,2))(x)
x = block(512,upscale=False)(x)
x=Conv3D(1024,kernel_size=(3,3,3),strides=(1,1,1))(x)
x=BatchNormalization()(x)
x=Activation('relu')(x)
x=MaxPooling3D(pool_size=(2,2,2))(x)
x = block(1024,upscale=False)(x)
...
def dt(folder1,cat):
    ...
    #print(file)
            ...
            dataset1=np.asarray(dataset1,dtype=np.float32)
            dataset1=dataset1.reshape((224,224,50,3))
