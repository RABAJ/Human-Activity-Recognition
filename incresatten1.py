...
from keras.layers import Input, Conv2D, Activation, BatchNormalization, GlobalAveragePooling2D, Dense, Dropout,Add,Multiply
...
x1=Conv2D(64,kernel_size=(1,1),padding='same',strides=(1,1))(p)
x1=BatchNormalization()(x1)

x2=Conv2D(16,kernel_size=(1,1),padding='same',strides=(1,1))(p)
x2=BatchNormalization()(x2)
x2=Activation('relu')(x2)
x2=Conv2D(16,kernel_size=(3,3),padding='same',strides=(1,1))(x2)
x2=BatchNormalization()(x2)

x3=Conv2D(32,kernel_size=(1,1),padding='same',strides=(1,1))(p)
x3=BatchNormalization()(x3)
x3=Activation('relu')(x3)
x3=Conv2D(32,kernel_size=(3,3),padding='same',strides=(1,1))(x3)
x3=BatchNormalization()(x3)

x4=MaxPooling2D(pool_size=(3,3), strides=(1,1), padding='same')(p)
x4=Conv2D(8,kernel_size=(3,3),padding='same',strides=(1,1))(x4)
x4=BatchNormalization()(x4)

layer_out = concatenate([x1, x2, x3,x4], axis=-1)

x5=Conv2D(120,kernel_size=(1,1),padding='same',strides=(1,1))(input_tensor)
