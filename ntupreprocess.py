...
#                     continue
    ...
    #                         print(x)
        ...
        plt.savefig('/home/ws2/Documents/nturgb_headspinal/'+title+'.png',dpi=100)
        croppingimage('/home/ws2/Documents/nturgb_headspinal/'+title+'.png')
#         plt.show()
...
# func('S008C003P007R001A022.skeleton')                    
for file in os.listdir('/home/ws2/Downloads/nturgb+d_skeletons'):
    if('P001' in file):
        title=file[:-9]
        if(os.path.exists(os.path.join('/home/ws2/Documents/nturgb_headspinal',title+'.png'))):
            print('continue')
            continue
        func(file)
