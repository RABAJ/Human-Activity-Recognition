...
bone_list=[[6,5],[5,14],[14,16],[16,18]]
...
#     plt.show()                
    plt.savefig('/home/ws2/Documents/msr_rightleg/'+title+'.png',dpi=100)
    croppingimage('/home/ws2/Documents/msr_rightleg/'+title+'.png')                    
    
    
    
for file in os.listdir('/home/ws2/Downloads/MSRAction3DSkeletonReal3D'):
    title=file[:-4]
    if(os.path.exists(os.path.join('/home/ws2/Documents/msr_rightleg/',title+'.png'))):
        continue
    func(file)
    print(file)
